...
drawer2 = Drawer.new
grapefruit_spoon = Silverware.new("grapefruit spoon")
drawer2.add_item(grapefruit_spoon)
knife2 = Silverware.new("knife")
drawer2.add_item(knife2)
fork2 = Silverware.new("fork")
drawer2.add_item(fork2)
spoon2 = Silverware.new("spoon")
drawer2.add_item(spoon2)
butter_knife = Silverware.new("butter knife")
drawer2.add_item(butter_knife)

drawer2.view_contents

removed_fork = drawer2.remove_item(fork2)
removed_fork.eat
...
drawer2.add_item(Silverware.new("spoon"))
drawer2.add_item(Silverware.new("fork"))
